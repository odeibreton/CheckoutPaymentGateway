...
{
    public class AddHandlersGeneralTests
    {
        private static IServiceCollection GetServices() => new ServiceCollection();

        [Fact]
        public void NullTypesShouldThrowException()
        {
        ...
        //{
        //    var services = GetServices();
        //    services.AddHandlers(typeof(AddHandlersGeneralTests).Assembly);
        ...
        //internal class Example1Attribute : HandlerAttribute
        //{
        //    public override Type Decorator => typeof(Example1Decorator<>);
        //}

        //internal class Example2Attribute : HandlerAttribute
        //{
